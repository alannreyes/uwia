-- Script para actualizar la base de datos con la configuración real
-- Archivo: 05_update_real_data.sql

-- Agregar columna pmc_field a la tabla document_prompts si no existe
ALTER TABLE document_prompts 
ADD COLUMN IF NOT EXISTS pmc_field VARCHAR(255) NOT NULL AFTER id;
